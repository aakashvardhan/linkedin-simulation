  ...
  return (
    <>
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        New to LinkedIn? <Link to="/register" className="text-linkedin font-medium hover:underline">Join now</Link>
      </p>
      <p className="mt-2 text-center text-sm text-gray-500">
        <Link to="/recruiter/login" className="text-linkedin hover:underline">Sign in as Recruiter</Link>
      </p>
    </>
  );
}
