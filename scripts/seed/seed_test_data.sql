...
VALUES
  (1, 'Alice', 'Applicant', 'alice@test.com', '$2b$10$placeholder_hash_alice', '555-0001',
   'San Jose', 'CA', 'USA'),
  (2, 'Bob',   'Applicant', 'bob@test.com',   '$2b$10$placeholder_hash_bob',   '555-0002',
   'San Jose', 'CA', 'USA');
...
VALUES
  (1, 1, 'Carol', 'Recruiter', 'carol@testcorp.com', '$2b$10$placeholder_hash_carol', 'recruiter'),
  (2, 1, 'Dave',  'Recruiter', 'dave@testcorp.com',  '$2b$10$placeholder_hash_dave',  'recruiter');
